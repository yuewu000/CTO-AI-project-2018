...
#adaptiver learning rate test using palceholder for this tesat 60 epochs with 0.2 decayed rate
...
def train_neural_network(x):
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "./model/model_15-layer_32x32x32t1deLR1_180e.ckpt")
